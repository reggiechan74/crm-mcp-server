 ...
 */
export function computeContentHash(dirPath) {
...
export function readManifest(crmRoot) {
    const path = manifestPath(crmRoot);
    if (!existsSync(path))
        return null;
    return JSON.parse(readFileSync(path, 'utf-8'));
}
export function writeManifest(crmRoot, manifest) {
 ...
 */
export function migrateManifest(crmRoot) {
 ...
 */
export function ensureManifest(crmRoot) {
 ...
 */
export function isCustomized(crmRoot, templateName, manifest) {
 ...
 */
export function listLocalTemplates(crmRoot) {
 ...
 */
export function readTemplateInfo(templateDir) {
 ...
 */
export function installBundledTemplates(crmRoot, templateNames) {
